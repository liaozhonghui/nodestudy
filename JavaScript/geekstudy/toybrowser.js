        ...
        return new Promise((resolve, reject) => {
            ...
            if (connection) { 
                ...
                connection = net.createConnection({
                    ...
                    console.log('发送的请求数据：', this.toString());
                    connection.write(this.toString());
                })
            }
            connection.on('data', (data) => {
                console.log('响应文本:', data.toString());
...
void async function() {
    ...
    console.log('获得的响应结果：' + JSON.stringify(response));
